...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice shooting, dribbling, and play intramural games",
    ...
    "Art Club": {
        ...
        "max_participants": 15,
        "participants": ["lila@mergington.edu", "carter@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Math Club": {
        "description": "Solve puzzles, prepare for math contests, and learn new concepts",
